...
# Add office-scripts to path for soffice module
_office_scripts = os.path.join(
    os.path.dirname(__file__), '..', '..', '..', '..', 'resources', 'office-scripts'
)
sys.path.insert(0, os.path.abspath(_office_scripts))
