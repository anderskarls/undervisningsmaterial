...
Skapa en output-katalog för momentet under `Undervisningsmaterial/`. Strukturen är `Undervisningsmaterial/[Ämne]/[Tema]/` baserat på valen i steg 1 (t.ex. `Undervisningsmaterial/Historia/Franska revolutionen/`). Ämne ska ha stor bokstav, tema ska vara läsbart med mellanslag.
...
Skriv momentplanen till `Undervisningsmaterial/[Ämne]/[Tema]/momentplan.md`.
...
Spara till `Undervisningsmaterial/[Ämne]/[Tema]/lektion-[N].docx`.
...
Spara till `Undervisningsmaterial/[Ämne]/[Tema]/presentation-lektion-[N].pptx`.
...
Avsluta med: "Ditt moment är klart! Alla filer finns i `Undervisningsmaterial/[Ämne]/[Tema]/`. Lektionsplanerna är Word-dokument, presentationerna är PowerPoint-filer och momentöversikten är en HTML-sida som du kan dela med eleverna via Google Sites — redo att använda direkt. Lycka till med undervisningen!"
