...
BRAIN_PATH = Path(os.environ.get("BRAIN_PATH", PROJECT_DIR.parent.parent))
...
MEMORY_CONFIG = {
    ...
    "indexing": {
        ...
        "excluded_folders": [
            ...
            ".obsidian", ".trash", ".git", ".claude", ".planning", ".agents", ".secrets",
    ...
    "search": {
        "default_limit": 10,
        "default_threshold": 0.3,  # Minimum similarity to return. Lowered from 0.5 on 2026-04-14: MiniLM-L6-v2 is English-trained and scores Swedish content 0.30-0.50 even on clearly related notes. 0.5 gave empty results for common Swedish queries.
